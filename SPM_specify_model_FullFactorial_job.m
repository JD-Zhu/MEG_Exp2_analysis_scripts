...
results_dir = 'E:\Judy\Exp2\6_MEG-data\Results_ROI\TSPCA10000_3\SPM_results_FullFactorial\';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(1).dept = 0; % independent factor?? (actually this should prob be 1, coz within-subject factor should be set to "dependent")
