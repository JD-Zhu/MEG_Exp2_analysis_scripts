...
For MQ system:
  ...
  distance of 6 gives on average 11.4 neighbours per channel;         (prob too many)
  distance of 7 gives on average 15.0 neighbours per channel;         (prob too many)
  'triangulation' method gives on average 7.6 neighbours per channel. (I used this for my MEG Exp 1)
%}

cfg        = [];
cfg.method = 'distance'; % or 'triangulation'
cfg.neighbourdist = 5; % distance threshold (only applicable to 'distance' method)
